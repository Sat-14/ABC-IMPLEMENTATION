...
import { Shield, Mail, Lock, ArrowRight, Fingerprint, FileCheck, Users, GitBranch, FolderTree, CheckCircle2 } from 'lucide-react'
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-border-subtle rounded-2xl shadow-2xl p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-text-secondary mt-1 text-sm">Sign in to access your dashboard</p>
            </div>
